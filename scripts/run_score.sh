...
BACKBONES_DIR="${BACKBONES_DIR:-/home/tedeschg/prj/protein-perturbation/experiments/dude-z_experiments/CSF1R/reference/output_reference_lmpnn/backbones}"
OUT_FOLDER="${OUT_FOLDER:-/home/tedeschg/prj/protein-perturbation/experiments/dude-z_experiments/CSF1R/reference/output_reference_score/}"
